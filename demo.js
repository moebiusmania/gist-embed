...
class GistEmbed extends HTMLElement {
  ...
  init() {
    ...
    Object(_libs__WEBPACK_IMPORTED_MODULE_0__["default"])(user, uuid).then(data => this.render(data));
  }
...
/* harmony default export */ __webpack_exports__["default"] = ((user, uuid) => {
  ...
  return fetch_jsonp__WEBPACK_IMPORTED_MODULE_0___default()(url).then(res => res.json())
    .then(data => {
