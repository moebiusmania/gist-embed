...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GistEmbed; });
...
class GistEmbed extends HTMLElement {
  ...
  init() {
    ...
    Object(_libs__WEBPACK_IMPORTED_MODULE_0__["default"])(user, uuid)
...
/* harmony default export */ __webpack_exports__["default"] = ((user, uuid) => {
  const url = `https://gist.github.com/${user}/${uuid}.json`;

  return fetch_jsonp__WEBPACK_IMPORTED_MODULE_0___default()(url)
    .then(res => res.json())
